        ...
        <section className="section section__heading bg-white p-4 py-20 pt-80 md:py-28 md:pt-80 lg:py-32 lg:pt-96" id="inicio">
            <div className="py-8 px-4 mt-16 md:mt-40 mx-auto max-w-screen-xl text-center lg:py-16">
                ...
                <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                    <a href="https://google.com" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-teal-700 hover:bg-teal-800 focus:ring-4 focus:ring-teal-300 transition-all">

    ...
    return (
        <div id={id} className="w-full max-w-xs bg-white border border-gray-200 rounded-lg shadow hover:shadow-lg transition-all">
            <div className="flex flex-col items-center px-4 pt-4 pb-4">
                <img className="w-48 h-48 sm:w-44 sm:h-44 lg:w-48 lg:h-48 mb-3 rounded-full shadow-lg hover:shadow-xl transition-all" loading="lazy" src={ image } alt={ name } width="200" height="200"/>

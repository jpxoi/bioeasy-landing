...
Los presentes Términos y Condiciones regulan el acceso, registro y uso de los siguientes canales digitales:
...
El Usuario debe proporcionar información verdadera, exacta y actualizada. Está prohibido registrarse utilizando la identidad o información de otra persona.

## 4. Cuenta personal y límite de dispositivos

### 4.1. Seguridad de la cuenta

La cuenta del Campus es personal, individual e intransferible.

El Usuario es responsable de:

- mantener la confidencialidad de sus credenciales;
- impedir que terceros accedan a su cuenta;
- cerrar sesión en dispositivos compartidos o ajenos;
- mantener actualizados sus datos de contacto; y
- informar inmediatamente cualquier acceso no reconocido o sospechoso.

Está completamente prohibido:

- compartir la cuenta, contraseña, códigos de acceso o sesiones con terceros;
- permitir que otra persona utilice la cuenta;
...
Cada Usuario puede mantener su sesión activa hasta en dos (2) dispositivos simultáneamente.
...
- requerir una verificación de identidad; o
- adoptar las medidas previstas en estos Términos y Condiciones cuando detecte incumplimientos reiterados, uso compartido o intentos de eludir el límite.

El uso ocasional de un nuevo dispositivo no constituye por sí mismo una infracción, siempre que el Usuario respete el límite de sesiones simultáneas y no comparta su acceso.

## 5. Uso permitido del Campus y sus contenidos
...
Los archivos PDF que tengan habilitada la opción de descarga podrán descargarse y conservarse exclusivamente para uso personal del Usuario autorizado.

La autorización de descarga no permite:

- compartir los archivos con terceros;
- publicarlos en sitios web, redes sociales, grupos, repositorios o plataformas;
- venderlos, alquilarlos o utilizarlos comercialmente;
- eliminar marcas, avisos de propiedad o medidas de identificación;
- modificarlos para atribuirse su autoría; o
- reproducirlos o distribuirlos total o parcialmente fuera de los límites permitidos por la legislación aplicable.

### 5.3. Videos

Los videos deben visualizarse exclusivamente mediante el reproductor habilitado dentro del Campus.

Está prohibido:

- descargar videos;
- grabar la pantalla, el audio o la reproducción;
- copiar, extraer o capturar el archivo o flujo de video;
- retransmitir o exhibir los videos a terceros;
- publicar, cargar o compartir los videos en cualquier plataforma;
...
- utilizar los Servicios para fines ilícitos o fraudulentos;
- intentar acceder a cuentas, cursos, archivos, áreas o sistemas para los que no tiene autorización;
- interferir con el funcionamiento, seguridad o disponibilidad de los Servicios;
- introducir malware, código malicioso o mecanismos automatizados no autorizados;
- realizar extracción masiva de información, scraping o ingeniería inversa;
- manipular registros, identificadores, sesiones o medidas de seguridad;
- suplantar a otra persona;
- compartir cuentas o superar deliberadamente el límite de dispositivos;
- copiar, grabar, publicar, redistribuir o comercializar contenidos sin autorización; o
- ayudar a terceros a realizar cualquiera de estas conductas.
...
El uso no autorizado puede vulnerar derechos de autor, marcas, medidas tecnológicas de protección u otros derechos, y puede generar responsabilidad conforme a la legislación aplicable.

## 9. Disponibilidad, cambios y servicios de terceros
...
- fallos de internet, energía o infraestructura;
- indisponibilidad de proveedores externos;
...
- actuaciones de terceros fuera de su control razonable;
- servicios externos independientes; o
- eventos de fuerza mayor.

Nada de lo dispuesto en estos Términos y Condiciones excluye o limita responsabilidades que no puedan excluirse conforme a la legislación peruana ni los derechos irrenunciables que correspondan al Usuario.

## 11. Eliminación de la cuenta y privacidad
...
Estos Términos y Condiciones se rigen por la legislación de la República del Perú.

Cualquier controversia se someterá a las autoridades administrativas, de protección de datos personales, de protección al consumidor o judiciales que resulten competentes conforme a la legislación peruana.
